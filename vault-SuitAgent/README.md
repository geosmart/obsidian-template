...
title: README
tags: []
created: 2026-02-23T13:48:15
updated: 2026-02-23T14:12:51
---
# README
...
想了解 SuitAgent 的完整设计思路和使用场景？查看详细文章：

**👉 [SuitAgent：基于Claude Code的AI代理诉讼法律服务系统](https://mp.weixin.qq.com/s/Atm48_tpp7bcQhT12P7Btg)**

## 项目概述

SuitAgent 是一个基于 **Claude Code 架构** 的诉讼法律服务智能分析系统，采用 10 个专业 AI 代理协作的模式，将复杂的诉讼案件分析分解为多个可独立执行的工作流，实现法律文书的工程化生成。

## ✨ 核心特性

- 🎯 **多阶段覆盖**：从诉前分析到判决执行，全流程支持
- 🚀 **一键启动**：上传文档即可自动分析，无需复杂配置
- 🔄 **灵活组合**：10 个专业 AI 代理可自由组合使用
...
SuitAgent 采用**四层架构设计**，将 10 个 Agent 按职能分为 4 个层级：
...
SuitAgent 基于 **Claude Code CLI** 运行，这是终端中的 AI 助手。
...
> **💡 提示**：除了 NPM 安装方式外，其他方式已内置 Node.js 运行时，无需单独安装。
...
1. **启动应用**：从启动台或应用程序文件夹中打开 cc-switch
2. **选择模型**：在应用中点击选择 AI 模型服务商
3. **输入密钥**：粘贴您的 API 密钥
...
确保 API 密钥和模型配置正确。如果没有此文件，请先创建并配置。
...
- **[cc-switch](https://github.com/farion1231/cc-switch)** - 快速切换不同 AI 模型配置
...
- **[Claude Code官方文档](https://docs.anthropic.com/claude-code)** - 了解 Claude Code
- **[Node.js官网](https://nodejs.org/)** - 安装 Node.js 和 npm
